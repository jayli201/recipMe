...
<body>
    ...
    <form action="" method="post">
         ...
         <div>
            <input type="number" id="instrCount" name="instrCount" placeholder="# of Instructions" min="0" required />
         </div>
         <div>
            <input type="number" id="cookTime" name="cookTime" placeholder="Total Time" min="0" required />
         </div>
         <div>
         <input list="countries" placeholder="Country">
